...
const MODE_INSTRUCTIONS: Record<string, string> = {
  "Ask Workflow": "Jawab pertanyaan user tentang workflow build WL-STUDIO.",
  "Generate PRD": "Buat PRD dari brief user dalam format WL-STUDIO. Extract nama bisnis, kategori, lokasi, dll. Rekomendasikan paket dan DESIGN.md.",
  ...
  "Lead to PRD": "Ubah data lead dari Lead Finder AI, Google Maps, atau deskripsi bisnis menjadi rekomendasi paket WL-STUDIO, PRD awal, dan suggested next action.",
