...
const REAL_LEADS: LeadFlowItem[] = [
  // --- 11 Juli 2026 ---
  {
    id: 'lf-real-38',
    date: '2026-07-11',
    leadName: 'Ndalem Eyang Dwijo',
    niche: 'Homestay / Guest House',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Unknown_Audience',
    adName: 'Guesthouse_Promo_Ad',
    status: 'new',
    notes: '[Greg] 2026-07-11 — Ringkasan:\n- Finding: Lead inbound bernama Ndalem Eyang Dwijo bertanya soal website villa.\n- Problem: Belum diketahui lokasi, status website existing, jumlah unit/kamar, dan channel booking utama.\n- Opportunity: Potensi website booking langsung.\n- Next action: Tunggu jawaban client.\n- Risk: Masih tahap sangat awal.',
    nextFollowUp: '2026-07-12T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 0,
    createdAt: '2026-07-11T00:48:00Z',
    updatedAt: '2026-07-11T00:48:00Z'
  },
  {
    id: 'lf-real-39',
    date: '2026-07-11',
    leadName: 'Client 37 - nomor akhir 8729',
    niche: 'Villa',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'new',
    notes: '[Greg] 2026-07-11 — Ringkasan:\n- Finding: Lead inbound bertanya soal website villa.\n- Problem: Belum diketahui nama villa, lokasi, jumlah unit/kamar, dan channel booking utama.\n- Opportunity: Potensi website booking langsung.\n- Next action: Tunggu jawaban client.\n- Risk: Masih tahap sangat awal.',
    nextFollowUp: '2026-07-12T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 0,
    createdAt: '2026-07-11T05:43:00Z',
    updatedAt: '2026-07-11T05:43:00Z'
  },
  ...
  // --- 10 Juli 2026 ---
  {
    id: 'lf-real-40',
    date: '2026-07-10',
    leadName: 'Bali rice field Homestay - nomor akhir 0871',
    niche: 'Homestay / Guest House',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Unknown_Audience',
    adName: 'Guesthouse_Promo_Ad',
    status: 'interested',
    notes: '[Greg] 2026-07-10 — Ringkasan:\n- Finding: Homestay bernama "Bali rice field Homestay" berlokasi di Sukabumi, beroperasi sejak akhir 2025. Menyewakan 1 rumah penuh, occupancy saat ini 4-5 tamu/bulan via Airbnb.\n- Problem: Bergantung penuh pada Airbnb, ingin memaksimalkan occupancy dan menyasar turis asing.\n- Opportunity: Sangat cocok untuk paket Pro Booking Rp 3,5 juta dengan dwibahasa (ID+EN) dan booking WA tanpa komisi, atau Premium Rp 6,5 juta untuk sistem pembayaran online.\n- Next action: Tunggu tanggapan client mengenai paket yang ditawarkan.\n- Risk: Homestay masih tergolong baru dan volume tamu masih rendah.',
    nextFollowUp: '2026-07-11T10:00',
    owner: 'Well',
    dealValue: 3500000,
    replyCount: 1,
    createdAt: '2026-07-10T18:13:00Z',
    updatedAt: '2026-07-11T07:53:00Z'
  },
  {
    id: 'lf-real-36',
    date: '2026-07-10',
    leadName: 'Client 36 - nomor akhir 7546',
    niche: 'Villa',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'new',
    notes: '[Greg] 2026-07-10 — Ringkasan:\n- Finding: Lead inbound bertanya soal website villa.\n- Problem: Belum diketahui nama villa, lokasi, jumlah unit, dan channel booking utama.\n- Opportunity: Potensi website booking langsung.\n- Next action: Tunggu jawaban atas pertanyaan kualifikasi dari Welli.\n- Risk: Masih tahap sangat awal.',
    nextFollowUp: '2026-07-11T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 0,
    createdAt: '2026-07-10T15:40:00Z',
    updatedAt: '2026-07-10T15:40:00Z'
  },
  {
    id: 'lf-real-34',
    date: '2026-07-10',
    leadName: 'Client 34 - nomor akhir 7563',
    niche: 'Villa',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'replied',
    notes: '[Greg] 2026-07-10 — Ringkasan:\n- Finding: Lead bertanya harga landing page untuk villa, lokasi belum diketahui.\n- Problem: Belum diketahui nama villa, lokasi, dan detail unit.\n- Opportunity: Diarahkan ke paket Standard promo Rp 2,0 juta (dari Rp 2,5 juta).\n- Next action: Tunggu jawaban lokasi villa atau kesediaan untuk telepon/Gmeet.\n- Risk: Masih membandingkan harga/tanya-tanya.',
    nextFollowUp: '2026-07-11T10:00',
    owner: 'Well',
    dealValue: 2000000,
    replyCount: 1,
    createdAt: '2026-07-10T11:14:00Z',
    updatedAt: '2026-07-10T11:14:00Z'
  },
  {
    id: 'lf-real-32',
    date: '2026-07-10',
    leadName: 'Villa Bali 3 Kamar - nomor akhir 8081',
    niche: 'Villa',
    sourceCampaign: 'WhatsApp inbound / tanya website villa Bali',
    adSet: 'Bali_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: '[Adrian] 2026-07-10 — Ringkasan:\n- Finding: Lead punya/mewakili villa di Bali, 1 unit 3 kamar, baru mau mulai jalan dan belum dipasarkan.\n- Problem: Belum ada channel pemasaran, belum ada review, perlu trust dan alur inquiry/booking yang rapi.\n- Opportunity: Cocok untuk website villa direct booking, terutama paket Pro Booking jika butuh bilingual dan form booking via WhatsApp untuk target harian + bulanan.\n- Next action: Well follow-up manual setelah client diskusi dengan team; tawarkan recap singkat atau Google Meet.\n- Risk: Belum diketahui nama villa, budget final, dan siapa decision maker utama.',
    nextFollowUp: '2026-07-12T10:00',
    owner: 'Well',
    dealValue: 3000000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-33',
    date: '2026-07-10',
    leadName: 'Client 33 - nomor akhir 6077',
    niche: 'Villa',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'new',
    notes: '[Greg] 2026-07-10 — Ringkasan:\n- Finding: Lead inbound bertanya soal website villa, tetapi data villa masih belum lengkap.\n- Problem: Belum diketahui apakah sudah punya website, jumlah unit/kamar, lokasi, dan channel booking utama.\n- Opportunity: Cocok untuk diarahkan ke website direct booking jika saat ini masih bergantung pada OTA/WA manual.\n- Next action: Tunggu jawaban client. Jika belum balas, follow-up singkat dengan fokus menanyakan website existing atau OTA/WA.\n- Risk: Lead masih tahap awal and belum ada indikasi budget/kebutuhan detail.',
    nextFollowUp: '2026-07-11T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 0,
    createdAt: '2026-07-10T00:43:00Z',
    updatedAt: '2026-07-10T00:43:00Z'
  },
  ...
  // --- 9 Juli 2026 ---
  {
    id: 'lf-real-37',
    date: '2026-07-09',
    leadName: 'Client website Bali',
    niche: 'Villa',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Bali_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'proposal_sent',
    notes: '[Adrian] 2026-07-10 — Ringkasan:\n- Finding: Lead di Bali, memiliki 5 villa yang saat ini dikelola oleh manajemen secara penuh (manajemen memegang akun & kalender OTA, commission split 20% OTA & 15% manajemen).\n- Problem: Kalender booking dipegang penuh oleh manajemen, sehingga perlu koordinasi untuk mendapatkan feed kalender agar tidak terjadi double booking di website baru. Belum punya tim cleaning/check-in sendiri jika keluar dari manajemen.\n- Opportunity: Sangat cocok untuk paket Pro Booking (Rp 3.500.000) atau Premium (Rp 6.500.000) dengan add-on Update Harga Mandiri (Rp 900.000) agar bisa update harga 5 villa sendiri.\n- Next action: Tunggu respon client setelah rincian paket dikirimkan.\n- Risk: Kalender dipegang penuh manajemen dan belum ada orang operasional mandiri.',
    nextFollowUp: '2026-07-11T10:00',
    owner: 'Well',
    dealValue: 3500000,
    replyCount: 2,
    createdAt: '2026-07-09T15:16:00Z',
    updatedAt: '2026-07-10T17:29:00Z'
  },
  {
    id: 'lf-real-35',
    date: '2026-07-09',
    leadName: 'Client 35 - nomor akhir 0228',
    niche: 'Villa',
    sourceCampaign: 'WhatsApp / inbound ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'replied',
    notes: '[Greg] 2026-07-10 — Ringkasan:\n- Finding: Lokasi villa di Cisarua, Puncak, Bogor, Jawa Barat.\n- Problem: Belum diketahui status website existing, jumlah unit/kamar, dan channel booking utama.\n- Opportunity: Potensi besar untuk website direct booking di area wisata Puncak.\n- Next action: Tunggu jawaban atas 3 pertanyaan dari Welli untuk kualifikasi.\n- Risk: Belum ada indikasi budget atau pain point spesifik.',
    nextFollowUp: '2026-07-11T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
    createdAt: '2026-07-09T22:22:00Z',
    updatedAt: '2026-07-10T06:14:00Z'
  },
  {
    id: 'lf-real-31',
    date: '2026-07-09',
    leadName: 'Client 31 - Tulamben Karangasem',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Karangasem_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: '4 unit villa, sekarang pakai Booking.com & Airbnb, awam soal website, ingin calon customer lebih cepat/banyak melihat villa. Perlu minta nama villa/link OTA/IG dan ajak Meet singkat. (Prioritas: High)',
    nextFollowUp: '2026-07-10T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-30',
    date: '2026-07-09',
    leadName: 'Client 30 - nomor akhir 9311',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: 'Minta telepon, sempat tanya apakah Welli di Bali. Concern trust/lokasi. Dijadscheduled telpon jam 19.00. (Prioritas: Medium-High)',
    nextFollowUp: '2026-07-10T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-29',
    date: '2026-07-09',
    leadName: 'Client 29 - nomor akhir 8988',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'replied',
    notes: 'Belum punya website, tanya biaya buat dari nol. Perlu gali unit/kamar dan model booking. (Prioritas: Medium)',
    nextFollowUp: '2026-07-10T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-28',
    date: '2026-07-09',
    leadName: 'Client 28 - belum teridentifikasi jelas',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'new',
    notes: 'Screenshot menunjukkan ingin mulai dari nol. Perlu tanya lokasi villa dan foto/fasilitas. (Prioritas: Medium)',
    nextFollowUp: '2026-07-10T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 0,
  ...
  },
  {
    id: 'lf-real-27',
    date: '2026-07-09',
    leadName: 'Client 27 - Villa Ciwidey',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Ciwidey_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: 'Booking masih via WA, 3 kamar, kapasitas 2-4 orang/villa, private pool air hangat, jacuzzi. Foto belum siap. Promo standard Rp1,8 juta. (Prioritas: Medium-High)',
    nextFollowUp: '2026-07-10T10:00',
    owner: 'Well',
    dealValue: 1800000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-26',
    date: '2026-07-09',
    leadName: 'Client 26 - THE SUBAHU VILLA, Padang Galak/Sanur',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Sanur_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'won',
    notes: 'Data properti lengkap sudah dikumpulkan, foto sudah ada. Website villa landing page + CMS sederhana. Deal seharga Rp2.500.000. (Prioritas: Very High)',
    nextFollowUp: '2026-07-13T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 3,
    closedAt: '2026-07-13T06:17:00Z',
    createdAt: '2026-07-09T11:00:00Z',
    updatedAt: '2026-07-13T06:17:00Z'
  },
  {
    id: 'lf-real-25',
    date: '2026-07-09',
    leadName: 'Client 25 - Apartemen Hotel',
    niche: 'Hotel & Resort',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Unknown_Audience',
    adName: 'Hotel_Resort_Ad',
    status: 'interested',
    notes: 'Tanya proses website apartemen hotel, masih awam, biasa pakai OTA. Mau diarahkan ke WhatsApp. Harga promo disampaikan Rp2,3 juta. (Prioritas: Medium)',
    nextFollowUp: '2026-07-10T10:00',
    owner: 'Well',
    dealValue: 2300000,
    replyCount: 1,
    createdAt: '2026-07-09T10:45:00Z',
    updatedAt: '2026-07-09T10:45:00Z'
  },
  {
    id: 'lf-real-24',
    date: '2026-07-09',
    leadName: 'Client 24 - Baba\'s Homestay Medan',
    niche: 'Homestay / Guest House',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Medan_Audience',
    adName: 'Guesthouse_Promo_Ad',
    status: 'lost',
    notes: '3 rumah, booking via WA/IG, Airbnb, Agoda. Tertarik tapi bertanya calendar sync Agoda/Airbnb. Setelah dijelaskan paket belum termasuk sync real-time, mereka bilang Google Place & IG sudah memadai. Jangan ditawarkan lagi dulu. (Prioritas: Low)',
    nextFollowUp: '2026-07-16T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-23',
    date: '2026-07-09',
    leadName: 'Client 23 - DATOYA Guest House, Banyumanik Semarang',
    niche: 'Homestay / Guest House',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Semarang_Audience',
    adName: 'Guesthouse_Promo_Ad',
    status: 'won',
    notes: 'Belum punya website, promosi IG/TikTok, tamu 2-3/bulan sejak April. Deal seharga Rp1.500.000. (Prioritas: Very High)',
    nextFollowUp: '2026-07-13T10:00',
    owner: 'Well',
    dealValue: 1500000,
    replyCount: 3,
  ...
  // --- 8 Juli 2026 ---
  {
    id: 'lf-real-22',
    date: '2026-07-08',
    leadName: 'Client 22 - nomor akhir 8041',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Bali_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'replied',
    notes: 'Lokasi Bali, mau dibuat dari nol kalau cocok budget. Perlu arahkan landing page lengkap + promo karena dari iklan. (Prioritas: Medium)',
  ...
  },
  {
    id: 'lf-real-20',
    date: '2026-07-08',
    leadName: 'Client 20 - nomor akhir 4448',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'replied',
    notes: 'Terlihat setuju dengan konsep website dari nol, tapi "boleh"-nya belum jelas. Perlu kunci scope: booking + payment, WA inquiry, atau cek ketersediaan. (Prioritas: Medium)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-19',
    date: '2026-07-08',
    leadName: 'Client 19 - Bali Villa',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Bali_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'contacted',
    notes: 'Inbound WhatsApp soal website villa. Lokasi Bali. Sudah dibalas untuk cek apakah villa-nya sudah punya website atau masih mau dibuat dari nol.',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
    createdAt: '2026-07-08T15:37:00Z',
    updatedAt: '2026-07-08T15:37:00Z'
  },
  {
    id: 'lf-real-15',
    date: '2026-07-08',
    leadName: 'Client 15 - nomor akhir 3189',
    niche: 'Homestay / Guest House',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Guesthouse_Ad',
    status: 'archived',
    notes: 'Sudah punya website, tanya sistem booking online untuk "pengelola kedua". Lalu jawab: "silakan layani client lain dulu, nanti saya hubungi lagi." (Prioritas: Low)',
    nextFollowUp: '2026-07-15T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 2,
  ...
  },
  {
    id: 'lf-real-14',
    date: '2026-07-08',
    leadName: 'Client 14 - Amoya Inn Ubud',
    niche: 'Homestay / Guest House',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Ubud_Audience',
    adName: 'Villa_Guesthouse_Ad',
    status: 'interested',
    notes: 'Lead lama dari Mei aktif lagi. Website sudah ada, target meningkatkan direct booking dari 5% dan mengimbangi OTA. (Prioritas: Medium-High)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-13',
    date: '2026-07-08',
    leadName: 'Client 13 - Kak Galang / Bali Selatan',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Bali_Audience',
    adName: 'Villa_Guesthouse_Ad',
    status: 'replied',
    notes: 'Guesthouse/villa 4 kamar model lumbung kayu. Target lokal + turis, mingguan/bulanan. Foto menyusul. Perlu kunci minat & slot. (Prioritas: Medium)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-12',
    date: '2026-07-08',
    leadName: 'Client 12 - Pak Agung / Deepa Villa',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Bali_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: 'Sudah punya website deepavilla.com, hampir sebulan belum menghasilkan booking. Perlu tracking: Analytics/Search Console dan audit CTA/traffic. (Prioritas: High)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-11',
    date: '2026-07-08',
    leadName: 'Client 11 - nomor akhir 6436',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Unknown_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: 'Sudah punya website tapi booking web kurang. Booking dominan dari WA/IG dan OTA. Concern occupancy/reservasi. (Prioritas: Medium-High)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-10',
    date: '2026-07-08',
    leadName: 'Client 10 - Puri Lebah Guest House, Ds. Banyuatis',
    niche: 'Homestay / Guest House',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Banyuatis_Audience',
    adName: 'Guesthouse_Promo_Ad',
    status: 'interested',
    notes: 'Guesthouse, diarahkan landing page promo Rp1,8 juta, termasuk domain, hosting, SEO dasar, support. Ditawarkan telpon/Google Meet. (Prioritas: Medium-High)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 1800000,
    replyCount: 1,
  ...
  },
  {
    id: 'lf-real-9',
    date: '2026-07-08',
    leadName: 'Client 9 - Pak Yoyo / Homebase Lombok',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Lombok_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: 'Lead lama klik iklan lagi. Punya homebaselombok.com, ingin upgrade: availability calendar, STAAH/channel manager, special offer button. Sensitif budget. (Prioritas: High)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 2,
  ...
  },
  {
    id: 'lf-real-8',
    date: '2026-07-08',
    leadName: 'Client 8 - The Amarta / Villa Teresa Bali',
    niche: 'Villa',
    sourceCampaign: 'July_Meta_Ads',
    adSet: 'Bali_Audience',
    adName: 'Villa_Website_Inquiry',
    status: 'interested',
    notes: 'Sudah punya 2 website: theamarta.com dan villateresabali.com. Kendala: direct booking jarang. Minta solusi + biaya. (Prioritas: High)',
    nextFollowUp: '2026-07-09T10:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
  ...
  },
  {
    ...
    adName: 'Villa_Guesthouse_Ad',
    status: 'contacted',
    notes: 'Tanya harga bikin website villa/guesthouse. Sudah diarahkan tanya lokasi properti dulu.',
  ...
  },
  {
    ...
    adName: 'Location_Ad',
    status: 'new',
    notes: 'Lead website villa, detail percakapan belum lengkap. Perlu identifikasi ulang.',
  ...
  },
  {
    ...
    adName: 'Villa_Guesthouse_Ad',
    status: 'interested',
    notes: 'Setelah meeting dikirim paket Pro Booking Rp3,1 juta, promo 1 minggu. Status: pertimbangan.',
  ...
  // --- 7 Juli 2026 ---
  {
    ...
    adName: 'Location_Ad',
    status: 'new',
    notes: 'Kondisi lead: terlalu awal. Masalah chat: opening awal terlalu mengarah to villa padahal baru jawab lokasi. Arah follow-up: jangan asumsi jenis bisnis, tanya dulu bisnisnya apa, tanya apakah sudah punya website atau masih dari nol, tawarkan solusi yang cocok setelah jelas.',
    nextFollowUp: '2026-07-08T14:00',
    owner: 'Well',
    dealValue: 2500000,
    replyCount: 1,
...
export default function LeadFlow() {
  ...
  // -------------------------------------------------------------
  useEffect(() => {
    const sortLeadFlow = (items: LeadFlowItem[]) => {
    ...
    if (currentLeads.length === 0) {
      currentLeads = sortLeadFlow([...REAL_LEADS]);
    } else {
      ...
      currentLeads = sortLeadFlow(currentLeads);
